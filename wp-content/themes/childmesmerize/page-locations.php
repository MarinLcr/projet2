...
<div class="post-list-item col-xs-12 space-bottom col-sm-12" data-masonry-width="<?php mesmerize_print_masonry_col_class(true); ?>">
    ...
    <h2 class="title_loc">Appartements à louer</h2>
    <p>Retrouver l’ensemble de nos biens immobiliers mis en locations par notre agence sur l’ensemble du territoire français. L’ensemble des chalets proposés par notre agence ont été examiné afin de s’assurer qu’ils répondent aux exigences de notre agence et de notre clientèle.</p>
